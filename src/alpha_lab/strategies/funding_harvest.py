...
отрицателен у BTCUSDT (-4.5e-5 на 7.8 % баров), ETHUSDT, LINKUSDT, BNBUSDT
(-1.8e-4; среднее неположительно (μ ≤ 0) на 69 % баров, строго отрицательно —
на 52.5 %, ниже порога окупаемости — на 82.6 %), DOTUSDT, SOLUSDT, BCHUSDT.
Значит, -inf — не аппроксимация «очень большим H», а
