...
rule('функция', 'Неизвестная функция Pine', (line) => {
  const KNOWN = new Set([
    ...
    'table.set_frame_width', 'table.set_position', 'table.set_text_color',
    'table.set_text_size', 'table.cell_set_text', 'table.cell_set_bgcolor',
    'line.new', 'line.delete', 'line.copy',
    'line.set_x1', 'line.set_y1', 'line.set_x2', 'line.set_y2',
    'line.set_xy1', 'line.set_xy2', 'line.set_xloc', 'line.set_yloc',
    'line.set_color', 'line.set_width', 'line.set_style', 'line.set_extend',
    'label.new', 'label.delete', 'label.copy',
    'label.set_x', 'label.set_y', 'label.set_xy', 'label.set_xloc',
    'label.set_text', 'label.set_tooltip', 'label.set_color', 'label.set_textcolor',
    'label.set_style', 'label.set_size', 'label.set_text_font_family',
